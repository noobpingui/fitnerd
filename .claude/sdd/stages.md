...
| `tests` | `test-author` → `verifier` (modo `red`) | `approvals.tasks` | tests, casillas de `tasks.md`, `verify-report.md` (red) | `Add failing tests for NNN-slug` |
...
| `tests` | ¿Los tests prueban los AC (lee 2 o 3)? ¿El red check es legítimo? ¿Fakes en lugar de mocks? |
